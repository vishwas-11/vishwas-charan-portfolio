  ...
  return (
    <header className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[70]">
      <Dock className="bg-background/90 backdrop-blur-md border border-border/50 shadow-2xl px-2">
        ...
        <DockIcon>
          <div className="group relative h-full w-full">
            <Link href="/about" className="flex h-full w-full items-center justify-center rounded-full text-foreground transition-colors">
        ...
        <DockIcon>
          <div className="group relative h-full w-full">
            <a href="https://github.com/vishwas-11" target="_blank" rel="noopener noreferrer" className="flex h-full w-full items-center justify-center rounded-full text-foreground transition-colors">
        ...
        <DockIcon>
          <div className="group relative h-full w-full">
            <a href="https://www.linkedin.com/in/vishwas-charan/" target="_blank" rel="noopener noreferrer" className="flex h-full w-full items-center justify-center rounded-full text-foreground transition-colors">
        ...
        <DockIcon>
          <div className="group relative h-full w-full">
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="flex h-full w-full items-center justify-center rounded-full text-foreground transition-colors">
        ...
        <DockIcon>
          <div className="group relative h-full w-full flex items-center justify-center">
            <AnimatedThemeToggle className="bg-transparent hover:bg-transparent shadow-none" />
            <div className={tooltipClasses}>
              <div className={tooltipArrow} />
              Theme
            </div>
